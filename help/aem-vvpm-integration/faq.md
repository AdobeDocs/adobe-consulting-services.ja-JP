...
Veeva Portal では、コンテンツタイプ（プロモーションなど）に基づいてメタデータを理解することが重要です。 Veeva Portal を確認した後、AEMでコンテンツメタデータスキーマを作成し、各アセット/ページに関連するすべてのメタデータを保持し、統合を設定して、2 つのシステム間でメタデータをマッピングします。
...
いいえ、現時点ではできません。 ビジュアルアノテーションには、API as a PDF経由でのみアクセスできます。
